...
public class Teste {
	...
	int ret = -1;
	ImageIcon duque, assassino, embaixador, capitao, condessa, coins, golpe;
	...
	public Teste(){
		...
		golpe = new ImageIcon("images/death.png");
		
		golpe.setImage(golpe.getImage().getScaledInstance(188, 172, 100));
